...
<body data-spy="scroll" data-target=".mainmenu-area">
    ...
    <nav class="mainmenu-area" data-spy="affix" data-offset-top="0">
        <div class="container">
            <div class="row">
                <div class="col-xs-6 col-sm-2 col-lg-2 logo">
                    <!-- Logo -->
                    <a href="#">
                        <p class="logotext " style="font-size: 23px; font-weight: bold;font-family: 'PT Sans Narrow', sans-serif; margin-top: 1px; color: white;
                ...
                <div class="menu-bar-hide col-xs-6 col-lg-offset-3">
                    <a href="#" class="menu-bar pull-right">
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                    </a>
                </div>
                <div class="hidden visible-lg col-lg-2">
                    <!-- Social Menu -->
                    <ul class="social">
                ...
                <div class="col-xs-12 col-sm-10  col-lg-8 smoth">
                    <!-- Mainmenu List -->
                    <ul class="nav mainmenu">
                        ...
                        <li><a href="LOGIN/stdlogin.php"><button class="loginbutton">LOGIN</button></a></li>
                    </ul>
                </div>
    ...
    <!-- Service-Section -->
    <!-- <section class="gray-bg fix" id="service-section">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h2 class="section-title" title="Services"><span>Services</span></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-md-4">
                        <div class="single-service">
                            <h3>Movie</h3>
                            <p>Praesent eget dolor sed felis sagittis pretium. Donec vitae aliquam felis. Morbi risus
                                nulla, efficitur eget mattis sit amet, blandit eu dolor.Curabitur luctus commodo nibh
                                sit amet eleifend. </p>
                            <a href="#" class="button white">Read more</a>
                        </div>
                    </div>
    ...
    <!-- Team-Section -->
    <section id="team-section" style="background-color: rgb(218, 159, 137);">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-lg-offset-3">
            <div class="single-team">
                <div class="team-photo">
    ...
    <!-- Video-Section -->
    <section id="video-section" style="background-color: rgb(176, 146, 121);">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-lg-12">
                    ...
                    <a href="https://www.youtube.com/channel/UCeYkElNkcDqExs3IsTg1U8Q">
                        <h5 style="font-weight: bold; color: rgb(9, 56, 56); margin-left: 10%;">Go to youTube <i class="fa fa-arrow-circle-o-right"></i></h5>
                    </a>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-4 col-md-offset-0 videostyle scaleipvideo" style="margin-top: 10px;">
                    <div class="embed-responsive embed-responsive-16by9">
                        <embed src="https://www.youtube.com/embed/A4ByJJ3QmnE" class="video-control embed-responsive-item" controls>
                ...
                <div class="col-xs-12 col-md-4 col-md-offset-0 videostyle scaleipvideo" style="margin-top: 10px;">
                    <div class="embed-responsive embed-responsive-16by9">
                        <embed src="https://www.youtube.com/embed/dxFST2H14SE" class="video-control embed-responsive-item" controls>
                ...
                <div class="col-xs-12 col-md-4 col-md-offset-0 videostyle scaleipvideo" style="margin-top: 10px;">
                    <div class="embed-responsive embed-responsive-16by9">
                        <embed src="https://www.youtube.com/embed/2VmjPayCMtk" class="video-control embed-responsive-item" controls>
                ...
                <div class="col-xs-12 col-md-4 col-md-offset-0 videostyle scaleipvideo" style="margin-top: 10px;">
                    <div class="embed-responsive embed-responsive-16by9">
                        <embed src="https://www.youtube.com/embed/Rlu4e8vAgY8" class="video-control embed-responsive-item" controls>
                        </embed>
                    </div>
                </div>
                <div class="col-xs-12 col-md-4 col-md-offset-0 videostyle scaleipvideo" style="margin-top: 10px;">
                    <div class="embed-responsive embed-responsive-16by9">
                        <embed src="https://www.youtube.com/embed/ZtZFX_rPcxU" class="video-control embed-responsive-item" controls>
                        </embed>
                    </div>
                </div>
                <div class="col-xs-12 col-md-4 col-md-offset-0 videostyle scaleipvideo" style="margin-top: 10px;">
                    <div class="embed-responsive embed-responsive-16by9">
                        <embed src="https://www.youtube.com/embed/opJR3q6Msks" class="video-control embed-responsive-item" controls>
                        </embed>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="https://anchor.fm/beyondtherange?fbclid=IwAR3P1vF-i65CPp6NbeTLeubvWfXapIs73VhdsWswLg8z2237XnFpOeBq_ZM" class="button white btnscale">Explor Here</a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a href="https://www.youtube.com/channel/UCeYkElNkcDqExs3IsTg1U8Q" class="button white btnscale">Go YouTube</a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a href="https://www.youtube.com/channel/UCgO0HBL8ZX2gLaEdJjhCgHw" class="button white btnscale">Go YouTube</a></td>
                                </tr>
                                <tr ">
                                        <td class=" movie-date"><span><img class="blogimg1" style="margin-top: 30px;" src="animation gif/icons8-verge-96.png" alt=""> <br /> <span>
                                            </td>
                                            ...
                                            <td><a href="https://www.youtube.com/channel/UClDwnvLiWuYRTIAqTuyGyXA" class="button white btnscale">Go YouTube</a></td>
                                </tr>
                                <!-- <tr>
    ...
    <!-- Gallery-Section -->
    <section class="gray-bg" id="gallery-section">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="single-gallery">
                        ...
                        <div class="gallery-details">
                            <div value="New Tab" onclick="window.open('https://www.youtube.com/watch?v=A4ByJJ3QmnE&t=4s')"><i class="fa fa-play"></i>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="single-gallery">
                        ...
                        <div class="gallery-details">
                            ...
                            <div value="New Tab" onclick="window.open('https://www.youtube.com/watch?v=ZtZFX_rPcxU')"><i class="fa fa-play"></i>
                            </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="single-gallery">
                        <div class="gallery-photo">
                            ...
                            <div class="gallery-details">
                                ...
                                <div value="New Tab" onclick="window.open('https://www.youtube.com/channel/UCeYkElNkcDqExs3IsTg1U8Q/community?lb=UgxLT03zhhNGPKTD-xF4AaABCQ')">
                    ...
                    <!-- <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="single-gallery">
                            ...
                            <div class="gallery-details">
                                <a href="https://www.youtube.com/watch?v=p1SPB16CdKE" class="work-popup"><i
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="single-gallery">
                            ...
                            <div class="gallery-details">
                                <a href="https://www.youtube.com/watch?v=pl0MYa4A4fQ" class="work-popup"><i
                                        class="fa fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="single-gallery">
                            ...
                            <div class="gallery-details">
                                <a href="https://www.youtube.com/watch?v=822ZyBmlSX0" class="work-popup"><i
                                        class="fa fa-play"></i></a>
                            </div>
                        </div>
                    </div> -->
                ...
                <div class="col-xs-12 col-lg-6 hidden-xs hidden-md">
                    ...
                    <svg width="40%" height="50vh" class="svgmg" viewBox="0 0 837 1045" version="1.1">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                            ...
                            <path d="M78.5,529 L147,569.186414 L147,648.311216 L78.5,687 L10,648.311216 L10,569.186414 L78.5,529 Z" id="Polygon-2" stroke="#EF4A5B" stroke-width="6" sketch:type="MSShapeGroup">
                            </path>
                            <path d="M773,186 L827,217.538705 L827,279.636651 L773,310 L719,279.636651 L719,217.538705 L773,186 Z" id="Polygon-3" stroke="#795D9C" stroke-width="6" sketch:type="MSShapeGroup">
                            </path>
                            <path d="M639,529 L773,607.846761 L773,763.091627 L639,839 L505,763.091627 L505,607.846761 L639,529 Z" id="Polygon-4" stroke="#F2773F" stroke-width="6" sketch:type="MSShapeGroup">
                            </path>
                            <path d="M281,801 L383,861.025276 L383,979.21169 L281,1037 L179,979.21169 L179,861.025276 L281,801 Z" id="Polygon-5" stroke="#36B455" stroke-width="6" sketch:type="MSShapeGroup">
                            </path>
                        </g>
                    </svg>
                </div>
    ...
    <!-- Footer-Area -->
    <footer class="pink-bg footer-area">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
